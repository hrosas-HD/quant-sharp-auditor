...
# =====================================================================
st.set_page_config(
    page_title="Quant/Sharp Auditor Pro v6.5",
    page_icon="🎯",
    layout="wide",
...
if "GEMINI_API_KEY" in st.secrets:
    ...
    # Usamos tu clave más reciente (Asegúrate de no borrarla en AI Studio)
...
def clean_json_response(text):
    ...
    try:
        # Intentar carga directa (Modo JSON estricto activado en el modelo)
        return json.loads(text)
    except:
        # Fallback por si la IA agrega markdown accidentalmente
...
def auditar_lote_informes(lista_pdfs, lista_imagenes):
    ...
    try:
        # Configuración de generación para forzar JSON válido
...
st.markdown(f"Protocolo de Seguridad v6.5 - Flujo Franco-Tirador Activo")
...
with st.sidebar:
    ...
    st.divider()
    st.caption("Quant/Sharp v6.5 | Auditoría Inteligente")
